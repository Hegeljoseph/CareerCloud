...
namespace CareerCloud.MVC.Controllers
{
    public class SecurityRoleController : Controller
    {
        ...
        {
            return View(db.SecurityRolePocoes.ToList());
        }
        ...
        public ActionResult Details(Guid? id)
        {
            ...
            SecurityRolePoco securityRolePoco = db.SecurityRolePocoes.Find(id);
        ...
        public ActionResult Create([Bind(Include = "Id,Role,IsInactive")] SecurityRolePoco securityRolePoco)
        {
            if (ModelState.IsValid)
            {
                ...
                db.SecurityRolePocoes.Add(securityRolePoco);
                db.SaveChanges();
        ...
        {
            SecurityRolePoco securityRolePoco = db.SecurityRolePocoes.Find(id);
            db.SecurityRolePocoes.Remove(securityRolePoco);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
