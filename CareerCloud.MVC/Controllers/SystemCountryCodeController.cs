...
namespace CareerCloud.MVC.Controllers
{
    public class SystemCountryCodeController : Controller
    {
        ...
        {
            return View(db.SystemCountryCodePocoes.ToList());
        }
        ...
        public ActionResult Details(string id)
        {
            ...
            SystemCountryCodePoco systemCountryCodePoco = db.SystemCountryCodePocoes.Find(id);
        ...
        public ActionResult Create([Bind(Include = "Code,Name")] SystemCountryCodePoco systemCountryCodePoco)
        {
            ...
            {
                db.SystemCountryCodePocoes.Add(systemCountryCodePoco);
                db.SaveChanges();
        ...
        {
            SystemCountryCodePoco systemCountryCodePoco = db.SystemCountryCodePocoes.Find(id);
            db.SystemCountryCodePocoes.Remove(systemCountryCodePoco);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
