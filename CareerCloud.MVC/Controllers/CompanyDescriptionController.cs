...
namespace CareerCloud.MVC.Controllers
{
    public class CompanyDescriptionController : Controller
    {
        ...
        {
            var companyDescriptionPocoes = db.CompanyDescriptionPocoes.Include(c => c.SystemLanguageCode);
            return View(companyDescriptionPocoes.ToList());
        }
        ...
        public ActionResult Details(Guid? id)
        {
            ...
            CompanyDescriptionPoco companyDescriptionPoco = db.CompanyDescriptionPocoes.Find(id);
        ...
        {
            ViewBag.LanguageId = new SelectList(db.SystemLanguageCodePocoes, "LanguageID", "Name");
            return View();
        }
        ...
        {
            CompanyDescriptionPoco companyDescriptionPoco = db.CompanyDescriptionPocoes.Find(id);
            db.CompanyDescriptionPocoes.Remove(companyDescriptionPoco);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
